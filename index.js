...
function handleSearchButtonClick() {
  ...
  filtereddata = dataSet.filter(function(address) {
    ...
    return (addressdate === filterDate || filterDate==="") &&(addressstate===filterstate || filterstate==="") && (addresscity===filtercity || filtercity==="")&& (addresscountry===filtercountry || filtercountry==="") && (addressshape===filtershape || filtershape==="")
  });
  renderTable();
}
